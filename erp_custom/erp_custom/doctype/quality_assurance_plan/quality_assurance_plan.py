...
#         current_page = 3   # Page 1 = Cover, Page 2 = Index
#         serial_no = 1
#         pdf_found = False
...
#         cover_doc = SimpleDocTemplate(cover_buffer, pagesize=A4)
#         cover_elements = []

#         cover_elements.append(Paragraph("<b>QUALITY ASSURANCE PLAN</b>", styles["Heading1"]))
...
#         index_buffer = io.BytesIO()
#         index_doc = SimpleDocTemplate(index_buffer, pagesize=A4)
#         index_elements = []

#         index_elements.append(Paragraph("<b>INDEX</b>", styles["Heading1"]))
#         index_elements.append(Spacer(1, 0.5 * inch))
...
class QualityAssurancePlan(Document):
    ...
    def merge_pdfs(self):
        ...
        # ---------------------------------------------------
        # STEP 2: Create Cover Page (WITH LETTERHEAD)
        # ---------------------------------------------------
        ...
        try:
            ...
            pass  # If image missing, continue without crashing

        # Title
        cover_elements.append(
            Paragraph("<b>QUALITY ASSURANCE PLAN</b>", styles["Heading1"])
        )
        cover_elements.append(Spacer(1, 0.5 * inch))
        ...
        index_elements.append(
            Paragraph("<b>INDEX</b>", styles["Heading1"])
        )
        index_elements.append(Spacer(1, 0.5 * inch))
